        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alalamtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض تركيا',
        image_1: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-1.jpg', 'تركيا - فيابورت & اسطنبول'],
        image_2: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-2.jpg', 'تركيا - بورصة & اسطنبول'],
        image_3: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-3.jpg', 'تركيا - فيابورت & اسطنبول'],
        image_4: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-4.jpg', 'تركيا - بورصة & اسطنبول'],
        image_5: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-5.jpg', 'تركيا - فيابورت & اسطنبول'],
        image_6: ['عروض-شركة-العالم/عروض-تركيا/عرض-تركيا-6.jpg', 'تركيا - طرابزون & اسطنبول'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-العالم/عروض-جورجيا/عرض-جورجيا-1.jpg', 'جورجيا - تبليسي & جوداوري'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-العالم/عروض-تايلاند/عرض-تايلاند-1.jpg', 'تايلاند - بوكيت & بانكوك'],
    },

    {
        title: 'عروض اندونيسيا',
        image_1: ['عروض-شركة-العالم/عروض-اندونيسيا/عرض-اندونيسيا-1.jpg', 'اندونيسيا - بونشاك & باندونج & جاكرتا'],
    },

    {
        title: 'عروض لندن',
        image_1: ['عروض-شركة-العالم/عروض-لندن/عرض-لندن-1.jpg', 'لندن - رحلة 8 أيام'],
    },

    {
        title: 'عروض روسيا',
        image_1: ['عروض-شركة-العالم/عروض-روسيا/عرض-روسيا-1.jpg', 'روسيا - موسكو وضواحيها'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966549578332?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alalamtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة العالم على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة العالم على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة العالم على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة العالم للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة العالم للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة العالم`;
            img.title = `مكتب سياحي - شركة العالم`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966549578332";
